...
using HC.AbpCore.Wechat.Messages.Dtos;
using System;
...
namespace HC.AbpCore.Wechat.Messages
{
    /// <summary>
    /// WechatMessage应用层服务的接口实现方法  
    ///</summary>
    [AbpAuthorize]
    public class WechatMessageAppService : AbpCoreAppServiceBase, IWechatMessageAppService
    {
