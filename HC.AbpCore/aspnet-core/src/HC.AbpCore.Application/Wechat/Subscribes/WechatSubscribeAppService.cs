...
using HC.AbpCore.Wechat.Subscribes.Dtos;

namespace HC.AbpCore.Wechat.Subscribes
{
    /// <summary>
    /// WechatSubscribe应用层服务的接口实现方法  
    ///</summary>
    [AbpAuthorize]
    public class WechatSubscribeAppService : AbpCoreAppServiceBase, IWechatSubscribeAppService
    {
